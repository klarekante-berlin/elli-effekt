...
const WelcomePage: React.FC<WelcomePageProps> = ({ onStart }) => {
  ...
  useEffect(() => {
    ...
    const titleSplit = new SplitType('h1', { types: 'chars' });
    const textSplit = new SplitType('.main-text', { types: 'lines' });
    ...
    gsap.set(textSplit.lines, { y: 30, opacity: 0 });
